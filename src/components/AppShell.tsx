...
const SHOW_SHELL_PATHS = ["/watch", "/live", "/spawn", "/messages", "/profile", "/council", "/wallet", "/missions", "/tasks", "/squads", "/market", "/trails", "/travel", "/map", "/friends", "/gifts", "/battles", "/creatures"];
