...
export default function MobileTabBar({ activeTab, onTabChange, unreadMatches = 0, unreadMessages = 0, lowBalance = false, hotCount = 0 }: TabBarProps) {
  ...
  const tabs = [
    ...
    { id: "hunt", label: "Trading", icon: HuntIcon, badge: hotCount, activeColor: C.hot, aura: true },
    { id: "work", label: "World", icon: WorldIcon, badge: 0, activeColor: C.indigo },
          ...
          return (
            <button key={tab.id} onClick={() => onTabChange(tab.id)} style={{
              ...
              <span style={{
                ...
                color: active ? ac : hasAura ? "rgba(255,255,255,0.75)" : C.muted,
